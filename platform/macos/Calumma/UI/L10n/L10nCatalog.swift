...
struct L10nCatalog: Equatable {
    ...
    var guideColor: String { self["guideColor"] }
    ...
    var layerLock: String { self["layerLock"] }
    var layerUnlock: String { self["layerUnlock"] }
    var renameLayer: String { self["renameLayer"] }
