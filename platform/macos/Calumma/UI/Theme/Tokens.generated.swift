...
enum Tokens {
    ...
    static let desk = Color(red: 0.054902, green: 0.070588, blue: 0.086275, opacity: 1.000000)
    static let deskGrid = Color(red: 0.101961, green: 0.133333, blue: 0.156863, opacity: 1.000000)
