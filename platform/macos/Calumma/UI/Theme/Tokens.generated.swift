...
enum Tokens {
    ...
    static let desk = Color(red: 0.101961, green: 0.125490, blue: 0.141176, opacity: 1.000000)
    static let deskGrid = Color(red: 0.235294, green: 0.278431, blue: 0.313725, opacity: 1.000000)
