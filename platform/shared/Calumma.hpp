...
CalmStatus calm_engine_create_clipping_mask(CalmEngine *engine, uint32_t index);
CalmStatus calm_engine_release_clipping_mask(CalmEngine *engine, uint32_t index);
int calm_engine_layer_is_clipped(CalmEngine *engine, uint32_t index);
int calm_engine_layer_is_clip_base(CalmEngine *engine, uint32_t index);
int calm_engine_layer_can_create_clipping_mask(CalmEngine *engine, uint32_t index);
